...
class VisualizationDemo_windows(VisualizationDemo):
    def run_on_video(self, frames, keep=False, long_video_start_fidx=-1):
        """
        Args:
            frames (List[np.ndarray]): a list of images of shape (H, W, C) (in BGR order).
                This is the format used by OpenCV.
        Returns:
            ...
            vis_output (VisImage): the visualized image output.
        """
        predictions = self.predictor((frames, keep, long_video_start_fidx))
...
class VideoPredictor(DefaultPredictor):
    ...
    def __call__(self, frames):
        ...
        if isinstance(frames, tuple):
            frames, keep, long_video_start_fidx = frames
        else:
            keep = False
        ...
        with torch.no_grad():  # https://github.com/sphinx-doc/sphinx/issues/4258
            ...
            inputs = {"image": input_frames, "height": height, "width": width, "keep": keep,
                      "long_video_start_fidx": long_video_start_fidx}
